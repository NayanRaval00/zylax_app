...
if(PAYPAL_MODE == 'test'){
    ...
    define('SITE_URL', 'https://localhost.vinod/test/paypal/'); // Use this for sandbox, change to live when in production
}
else{
    ...
    define('SITE_URL', 'https://dev2.zylaxonline.com.au/'); // Use this for sandbox, change to live when in production
}
