...
class SystemUsers extends Controller
{
    ...
    {
        $data['main_page'] = TABLES . 'manage-system-users';

        $settings = get_settings('system_settings', true);
        $data['title'] = 'Manage System Users | ' . $settings['app_name'];
        $data['meta_description'] = 'Manage System Users | ' . $settings['app_name'];

        $data['system_users_result'] = $this->adminTable
        ->orderBy('id', 'DESC')
        ->findAll();
    ...
    public function add_brand()
    {
        ...
        if ($this->request->getMethod() === 'POST') {
            ...
            if ($main_image->isValid() && !$main_image->hasMoved()) {
                ...
                $exist_brand = $this->adminTable->where('name', $this->request->getPost('brand_input_name'))->first();
                ...
                if($exist_brand){
                    ...
                    // dd($data);
                    $brand_added = $this->adminTable->insert($data);
    ...
    public function update_brand_status($id, $status)
    {
        ...
        $brand_updated = $this->adminTable->update($id, $data);
    ...
    public function delete_brand()
    {
        ...
        $brand_deleted = $this->adminTable->delete($brand_id);
    ...
    public function edit_brand()
    {
        $edit_id = $this->request->getGet('edit_id');
            ...
            $data['fetched_data'] = $this->adminTable->where('id', $edit_id)->first();
            ...
            if($main_image != ""){
                ...
                if ($main_image->isValid() && !$main_image->hasMoved()) {
                    ...
                    if($exist_brand){
                        ...
                        // dd($data);
                        $updated = $this->adminTable->update($edit_brand_id, $data);
