...
class Setting extends Controller
{
    ...
    {
        $data['main_page'] = FORMS . 'settings';

        $settings = get_settings('system_settings', true);
        $data['title'] = 'Settings | ' . $settings['app_name'];
        $data['meta_description'] = 'Settings | ' . $settings['app_name'];

        $data['logo'] = get_settings('logo');
        $data['favicon'] = get_settings('favicon');
        $data['settings'] = get_settings('system_settings', true);
        $data['shiprocket_settings'] = get_settings('shipping_method', true);
        $data['currency'] = get_settings('currency');
