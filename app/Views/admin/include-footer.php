...
<footer class="main-footer text-right">
    ...
    ?>
        <strong> <?php // echo (isset($settings['copyright_details']) && !empty($settings['copyright_details'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $settings['copyright_details'])) : " " ?> </strong>
    <?php // } else { ?>
        ...
        <strong>Copyright &copy; <?= date('Y') ?> - <?= date('Y') + 1 ?> <a target="_blank" href="<?= base_url('admin/home') ?>"></a>, All Right Reserved <a target="_blank" href="https://www.zylax.com.au/">zylax.com</a>.</strong>
    <?php //} ?>
