...
<?php if (session()->getFlashdata('message')) { ?>
    <script>
        Swal.fire('<?= session()->getFlashdata('message_type') ?>', "<?= session()->getFlashdata('message') ?>", '<?= session()->getFlashdata('message_type') ?>');
    </script>
<?php } ?>


<?php
if (session()->getFlashdata('authorize_flag')) { ?>
    <script>
        Swal.fire('Warning', "<?= session()->getFlashdata('authorize_flag') ?>", 'warning');
    </script>
<?php }
session()->setFlashdata('authorize_flag', "");

?>

<script>
    let custom_category_table = new DataTable('#custom_category_table');
</script>