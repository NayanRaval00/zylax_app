                                    ...
                                    <div class="col-md-4 col-sm-6 col-12 mb-3">
                                        ...
                                        <select id="status-1" name="order_status" class="form-control"
                                            ...
                                            <option value="missing"
                                                <?php echo ($orders_details[0]['order_status'] == 'missing' ? 'selected' : ''); ?>>
                                                Missing Orders</option>
                                            <option value="paid"
                                                <?php echo ($orders_details[0]['order_status'] == 'paid' ? 'selected' : ''); ?>>
                                                Paid</option>
                                            <option value="pending"
                                                <?php echo ($orders_details[0]['order_status'] == 'pending' ? 'selected' : ''); ?>>
                                                Pending</option>
                                            ...
                                            <option value="shipped"
                                                ...
                                                Shipped</option>
                                            <option value="unpaid"
                                                <?php echo ($orders_details[0]['order_status'] == 'unpaid' ? 'selected' : ''); ?>>
                                                Unpaid</option>
                                        </select>
                                    </div>
