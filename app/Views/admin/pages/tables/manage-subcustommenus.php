                    ...
                    <div class="card content-area p-4">
                        ...
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="<?= base_url() . 'admin/menu/create_subcustommenu/'.$parent_id ?>"
                                    class="btn btn-block  btn-outline-primary btn-sm">Add New Sub Custom Menus</a>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        $('#subcustomMenusTable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= base_url('admin/menu/fetchSubCustomMenus/'.$parent_id) ?>",
                "type": "POST"
            },
            // "columnDefs": [
