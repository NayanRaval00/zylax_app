                    ...
                    <div class="card content-area p-4">
                        ...
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="<?= base_url() . 'admin/category/create_category' ?>"
                                    class="btn btn-block  btn-outline-primary btn-sm">Add Category</a>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        $('#categoryTable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "<?= base_url('admin/category/fetchCategories') ?>",
                "type": "POST"
            },
            // "columnDefs": [
