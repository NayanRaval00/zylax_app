<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Manage Sub Sub Custom Menus</h4>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card content-area p-4">
                        ...
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="<?= base_url() . 'admin/menu/create_subcustommenu/'.$parent_id.'/'.$subcustommenu_id ?>"
                                    class="btn btn-block  btn-outline-primary btn-sm">Add New Sub Sub Custom Menus</a>
                            </div>
                        </div>
                        <div class="card-innr" id="list_view_html">
                            <div class="card-head">
                                <h4 class="card-title">Sub Custom Menus</h4>
                            </div>
                            <div class="card-body">

                                <table id="subcustomMenusTable" class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th scope="col">Id</th>
                                            <th scope="col">Title</th>
                                            <!-- <th scope="col">Parent Custom Sub</th> -->
...
<script>
    $(document).ready(function () {
        $('#subcustomMenusTable').DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": {
                "url": "<?= base_url('admin/menu/fetchSubSubCustomMenus/'.$parent_id.'/'.$subcustommenu_id) ?>",
                "type": "POST"
            },
            // "columnDefs": [
