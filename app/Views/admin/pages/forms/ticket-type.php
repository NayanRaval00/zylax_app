            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/tickets/add_ticket_type'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-success"><?= (isset($fetched_data[0]['id'])) ? 'Update Ticket Type' : 'Add Ticket Type' ?></button>
                                </div>
                            </div>
