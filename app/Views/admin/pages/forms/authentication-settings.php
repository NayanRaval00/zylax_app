            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <form class="form-horizontal" action="<?= base_url('admin/authenticationsettings/update_authentication_settings'); ?>" method="POST" id="payment_setting_form" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-success">Update Authentication Settings</button>
                                </div>
