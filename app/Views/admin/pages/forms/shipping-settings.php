            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <form class="form-horizontal" action="<?= base_url('admin/shippingsettings/update_shipping_settings'); ?>" method="POST" id="payment_setting_form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-success">Update Shipping Settings</button>
                                    </div>
                                </div>
