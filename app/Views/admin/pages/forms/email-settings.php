            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <!-- form start -->
                        <form class="form-horizontal" action="<?= base_url('admin/emailsettings/set_email_settings'); ?>" method="POST" id="add_product_form" enctype="multipart/form-data">
                            <!-- card -->
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-success"><?= (isset($email_settings)) ? 'Update Email Settings' : 'Add Email Settings' ?></button>
                                </div>
