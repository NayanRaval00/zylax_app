            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        <form class="form-horizontal" action="<?= base_url('admin/offer/update_offer'); ?>" method="POST" id="payment_setting_form" enctype="multipart/form-data">
                            <div class="card-body">

                                <div class="form-group">
                                    <?php if (isset($fetched_data['id'])) {
                                    ?>
                                        <input type="hidden" name="edit_offer" value="<?= $fetched_data['id'] ?>">
                                    <?php } ?>
                                    ...
                                    <select name="offer_type" id="offer_type" class="form-control type_event_trigger" required="">
                                        ...
                                        <option value="default" <?= (@$fetched_data['type'] == "default") ? 'selected' : ' ' ?>>Default</option>
                                ...
                                <div id="type_add_html">
                                    ...
                                    <div class="form-group slider-categories <?= $hiddenStatus ?> ">
                                        ...
                                        <select name="category_id" class="form-control">
                                            ...
                                            ?>
                                                <option value="<?= $row['id'] ?>" <?php if($row['id'] == $fetched_data['type_id']){ echo "selected"; } ?>> <?= $row['name'] ?></option>
                                            <?php
                                                }
                                            }
                                            ?>
