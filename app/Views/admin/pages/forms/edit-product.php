                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/product/update_product'); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="pro_input_name" placeholder="Product Name" name="pro_input_name" value="<?= (isset($product_details[0]['name'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $product_details[0]['name'])) : "" ?>">
                                </div>
                                                                ...
                                                                <div class="tab-pane fade active show" id="general-settings" role="tabpanel" aria-labelledby="general-settings-tab">
                                                                    ...
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="col col-xs-12">
                                                                            ...
                                                                            <select type="text" class="col form-control stock-simple-mustfill-field comman_select2" id="simple_product_stock_status">
