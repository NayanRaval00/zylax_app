      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-info">
            <!-- form start -->
            <form class="form-horizontal" action="<?= base_url('admin/privacypolicy/update_return_policy_settings'); ?>" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <button type="submit" class="btn btn-success">Return Policy</button>
              </div>
          </div>
