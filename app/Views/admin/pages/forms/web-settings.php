            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/websetting/update_web_settings') ?>" method="POST" id="system_setting_form" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="hidden" id="old_logo" name="old_logo" value="<?= (isset($web_settings['logo'])) ? output_escaping($web_settings['logo']) : '' ?>" />
                                                </div>
                                                <?php if(isset($web_settings['logo'])): ?>
                                                    <label class="text-danger mt-3">*Only Choose When Update is necessary</label>
                                                    <div class="container-fluid row image-upload-section">
                                                        <div class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image">
                                                            <div class="image-upload-div">
                                                                <img class="img-fluid mb-2" src="<?= base_url().$web_settings['logo'] ?>" alt="Image Not Found">
                                                            </div>
                                                            <input type="hidden" name="category_input_image" value="<?= base_url().$web_settings['logo'] ?>">
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            <div class="col-md-4 form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="hidden" id="old_footer_logo" name="old_footer_logo" value="<?= (isset($web_settings['footer_logo'])) ? output_escaping($web_settings['footer_logo']) : '' ?>" />
                                                </div>
                                                <?php if(isset($web_settings['footer_logo'])): ?>
                                                    <label class="text-danger mt-3">*Only Choose When Update is necessary</label>
                                                    <div class="container-fluid row image-upload-section">
                                                        <div class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image">
                                                            <div class="image-upload-div">
                                                                <img class="img-fluid mb-2" src="<?= base_url().$web_settings['footer_logo'] ?>" alt="Image Not Found">
                                                            </div>
                                                            <input type="hidden" name="category_input_image" value="<?= base_url().$web_settings['footer_logo'] ?>">
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            <div class="col-md-4 form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="hidden" id="old_favicon" name="old_favicon" value="<?= (isset($web_settings['favicon'])) ? output_escaping($web_settings['favicon']) : '' ?>" />
                                                </div>
                                                <?php if(isset($web_settings['favicon'])): ?>
                                                    <label class="text-danger mt-3">*Only Choose When Update is necessary</label>
                                                    <div class="container-fluid row image-upload-section">
                                                        <div class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image">
                                                            <div class="image-upload-div">
                                                                <img class="img-fluid mb-2" src="<?= base_url().$web_settings['favicon'] ?>" alt="Image Not Found">
                                                            </div>
                                                            <input type="hidden" name="category_input_image" value="<?= base_url().$web_settings['favicon'] ?>">
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="return_title">Shipping GST</label>
                                        <input type="text" class="form-control" name="shipping_gst" value="<?= (isset($web_settings['shipping_gst'])) ? output_escaping($web_settings['shipping_gst']) : '' ?>" placeholder="Shipping GST" />
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="return_description">Product GST</label>
                                        <input type="text"  class="form-control" name="product_gst"  placeholder="Product GST" value="<?= (isset($web_settings['product_gst'])) ? output_escaping($web_settings['product_gst']) : '' ?>">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="return_description">Order GST</label>
                                        <input type="text"  class="form-control" name="order_gst"  placeholder="Order GST" value="<?= (isset($web_settings['order_gst'])) ? output_escaping($web_settings['order_gst']) : '' ?>">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-md-4">
                                        <label for="return_title">Disable Checkout</label>
                                        <input type="checkbox" name="checkout_disbaled" <?= (isset($web_settings['checkout_disbaled']) && $web_settings['checkout_disbaled'] == '1') ? 'Checked' : ''  ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                    </div>
                                </div>
