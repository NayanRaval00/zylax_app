                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="fill_your_mobile_and_password_to_sign_in" class="form-control" value="<?= (isset($lang_labels['fill_your_mobile_and_password_to_sign_in']) && !empty($lang_labels['fill_your_mobile_and_password_to_sign_in'])) ? $lang_labels['fill_your_mobile_and_password_to_sign_in'] : 'Fill your mobile and password to sign in.'; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
