            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <!-- form start -->
                        <form class="form-horizontal" action="<?= base_url('admin/faq/update_faq'); ?>" method="POST" id="add_product_form" enctype="multipart/form-data">
                            <?php if (isset($fetched_data['id'])) { ?>
                                <input type="hidden" name="edit_faq" value="<?= @$fetched_data['id'] ?>">
                            <?php } ?>
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="question" placeholder="Faq Question" name="question" value="<?= isset($fetched_data['question']) ? output_escaping($fetched_data['question']) : "" ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="mb-3">
                                        <textarea name="answer" class="textarea addr_editor" id="answer" placeholder="Place answer"><?= (isset($fetched_data['id'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $fetched_data['answer'])) : ''; ?></textarea>
                                    </div>
                                </div>
