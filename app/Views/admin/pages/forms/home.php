            ...
            <div class="row">
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body text-right">
                                        ...
                                        <h3 class="text-bold-600"><?php // echo $order_counter ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body text-right">
                                        ...
                                        <h3 class="text-bold-600"><?php // echo $user_counter ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body text-right">
                                        ...
                                        <h3 class="text-bold-600"><?php // echo $delivery_boy_counter ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="media d-flex">
                                    ...
                                    <div class="media-body text-right">
                                        ...
                                        <h3 class="text-bold-600"><?php // echo $product_counter ?></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box total-info-box ">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text text-white">Total Earnings (<?php // echo $currency ?>) </span>
                            <span class="info-box-number text-white"><?php // echo number_format($total_earnings, 2) ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box details-box">
                        <span class="info-box-icon text-white"> <i class="far fa-money-bill-alt"></i></span>
                        <div class="info-box-content">
                            <span class="info-box-text text-white">Admin Earnings (<?php // echo $currency ?>) </span>
                            <span class="info-box-number text-white"><?php // echo number_format($admin_earnings, 2) ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6 col-12">
                    <div class="info-box bg-secondary">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Seller Earnings (<?php // echo $currency ?>) </span>
                            <span class="info-box-number"><?php // echo number_format($seller_earnings, 2) ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xs-12">
                    <div class="alert sold-products ">
                        ...
                        <h6><i class="icon fa fa-info"></i> <?php // echo $count_products_availability_status ?> Product(s) sold out!</h6>
                        <a href="<?php // echo base_url('admin/product/?flag=sold') ?>" class="text-decoration-none small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xs-12">
                    <div class="alert alert-primary alert-dismissible">
                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                        <h6><i class="icon fa fa-info"></i> <?php // echo $count_products_low_status ?> Product(s) low in stock!<small> (Low stock limit <?php // echo isset($settings['low_stock_limit']) ? $settings['low_stock_limit'] : '5' ?>)</small></h6>
                        <a href="<?php // echo base_url('admin/product/?flag=low') ?>" class="text-decoration-none small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                ...
                <div class="row col-12 d-flex">
                    ...
                    <div class="col-4">
                        <div class="small-box bg-success">
                            <div class="inner">
                                <h3><?php // echo (isset($count_approved_sellers) && !empty($count_approved_sellers)) ?  $count_approved_sellers : 0; ?></h3>
                    ...
                    <div class="col-4">
                        <div class="small-box bg-info">
                            <div class="inner">
                                <h3><?php // echo (isset($count_not_approved_sellers) && !empty($count_not_approved_sellers)) ?  $count_not_approved_sellers : 0; ?></h3>
                    ...
                    <div class="col-4">
                        <div class="small-box bg-danger">
                            <div class="inner">
                                <h3><?php // echo (isset($count_deactive_sellers) && !empty($count_deactive_sellers)) ?  $count_deactive_sellers : 0; ?></h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 ">
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    <table class='table-striped' id='seller_table' data-toggle="table" data-url="<?php // echo base_url('admin/Category/top_category')  ?>" data-click-to-select="true" data-side-pagination="server" data-show-columns="true" data-show-refresh="true" data-sort-name="sd.id" data-sort-order="DESC" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-query-params="queryParams">
                                        <thead>
                                            <tr>
                ...
                <div class="row col-12 d-flex">
                    <div class="col-3">
                        <div class="small-box awaiting-box">
                            <div class="inner">
                                <h3 class="text-white"><?php // echo $status_counts['awaiting'] ?></h3>
                    ...
                    <div class="col-3">
                        <div class="small-box received-box">
                            <div class="inner">
                                <h3 class="text-white"><?php // echo $status_counts['received'] ?></h3>
                    ...
                    <div class="col-3">
                        <div class="small-box processed-box">
                            <div class="inner">
                                <h3 class="text-white"><?php // echo $status_counts['processed'] ?></h3>
                    ...
                    <div class="col-3">
                        <div class="small-box shipped-box">
                            <div class="inner">
                                <h3 class="text-white"><?php // echo $status_counts['shipped'] ?></h3>
                    ...
                    <div class="col-3">
                        <div class="small-box delivered-box">
                            <div class="inner">
                                <h3 class="text-white"><?php // echo $status_counts['delivered'] ?></h3>
                    ...
                    <div class="col-3">
                        <div class="small-box bg-secondary">
                            <div class="inner">
                                <h3><?php // echo $status_counts['returned'] ?></h3>
                                <p>Returned</p>
                            </div>
                            <div class="icon">
                        ...
                        "ignoreColumn": ["state"] 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="total" data-sortable='true' data-visible="true">Total(<?php // echo $curreny ?>)</th>
                                        ...
                                        <th data-field="wallet_balance" data-sortable='true' data-visible="true">Wallet Used(<?php // echo $curreny ?>)</th>
                                        <th data-field="promo_code" data-sortable='true' data-visible="false">Promo Code</th>
                                        <th data-field="promo_discount" data-sortable='true' data-visible="true">Promo disc.(<?php // echo $curreny ?>)</th>
                                        <th data-field="final_total" data-sortable='true'>Final Total(<?php // echo $curreny ?>)</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="tab-pane " role="tabpanel" aria-labelledby="product-rating-tab">
                        ...
                        <table class='table-striped' id="order_tracking_table" data-toggle="table" data-url="<?php // echo base_url('admin/orders/get-order-tracking') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-query-params="order_tracking_query_params">
                            <thead>
                                <tr>
                                    <th data-field="id" data-sortable="true">ID</th>
...
<div class="modal fade" id="deactive_sellers" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <table class='table-striped' id='seller_table' data-toggle="table" data-url="<?php // echo base_url('admin/sellers/deactive_sellers') ?>" data-click-to-select="true" data-side-pagination="" data-pagination="true" data-page-list="[1,2,3,4]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="sd.id" data-sort-order="DESC" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-query-params="queryParams">
                    <thead>
                        <tr>
                            <th data-field="id" data-sortable="true">ID</th>
...
<div class="modal col-12 fade" id="approved_sellers" tabindex="-1" role="dialog" aria-labelledby="approved_sellers" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class='table-striped' id='seller_table' data-toggle="table" data-url="<?php // echo base_url('admin/sellers/approved_sellers') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5,10,15,20,25]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="sd.id" data-sort-order="DESC" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-query-params="queryParams">
                    <thead>
                        <tr>
                            <th data-field="id" data-sortable="true">ID</th>
                            <th data-field="name" data-sortable="false">Name</th>
...
<div class="modal col-12 fade" id="not_approved_sellers" tabindex="-1" role="dialog" aria-labelledby="approved_sellers" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-lg">
            ...
            <div class="modal-body">
                <table class='table-striped' id='seller_table' data-toggle="table" data-url="<?php // echo base_url('admin/sellers/not_approved_sellers') ?>" data-click-to-select="true" data-side-pagination="client" data-pagination="true" data-page-list="[1,3,5,7,10]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="sd.id" data-sort-order="DESC" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel"]' data-query-params="queryParams">
                    <thead>
                        <tr>
                            <th data-field="id" data-sortable="true">ID</th>
                            <th data-field="name" data-sortable="false">Name</th>
