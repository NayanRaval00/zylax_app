...
<aside class="main-sidebar elevation-2 sidebar-dark-indigo">
    ...
    <a href="<?= base_url('admin/home') ?>" class="brand-link">
        <!-- <img src="<?php // echo base_url()  . get_settings('favicon') ?>" alt="<?php // echo $settings['app_name']; ?>" title="<?php // echo $settings['app_name']; ?>" class="brand-image"> -->
       <!-- <img src="<?= base_url() ?>" alt="<?php echo $settings['app_name']; ?>" title="<?php echo $settings['app_name']; ?>" class="brand-image"> -->
        <!-- <span class="brand-text font-weight-light small"><?php echo $settings['app_name']; ?></span> -->
    </a>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-flat" data-widget="treeview" role="menu" data-accordion="false">
               ...
               with font-awesome or any other icon font library -->
                ...
                <?php // if (has_permissions('read', 'orders')) { ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <?php // if (has_permissions('read', 'orders')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/Adminorders/') ?>" class="nav-link">
                ...
                <?php // if (has_permissions('read', 'categories')) { ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php // if (has_permissions('read', 'categories')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/menu/create_menu') ?>" class="nav-link">
                            ...
                            <?php // if (has_permissions('read', 'categories')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/menu/custommenus/') ?>" class="nav-link">
                                        <i class="fa fa-bullseye nav-icon"></i>
                                        <p>Custom Menus</p>
                                    </a>
                                </li>
                ...
                <?php // if (has_permissions('read', 'categories')) { ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php // if (has_permissions('read', 'categories')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/category/create_category') ?>" class="nav-link">
                                        <i class="fa fa-plus-square nav-icon"></i>
                                        <p>Add Category</p>
                                    </a>
                                </li>
                ...
                <?php // if (has_permissions('read', 'categories')) { ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php // if (has_permissions('read', 'categories')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/shippingcategory/manage_shipping_category') ?>" class="nav-link">
                                        <i class="fa fa-bullseye nav-icon"></i>
                                        <p>Shipping Category</p>
                                    </a>
                                </li>
                            <?php // } ?>
                        </ul>
                    ...
                    <li class="nav-item has-treeview ">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <?php // if (has_permissions('read', 'attribute_set')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/attributeset/manage_attribute_set') ?>" class="nav-link">
                            ...
                            <?php // if (has_permissions('read', 'attribute')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/attributes/manage_attribute') ?>" class="nav-link">
                            ...
                            <?php // if (has_permissions('read', 'tax')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/taxes/manage_taxes') ?>" class="nav-link">
                            ...
                            <?php // if (has_permissions('read', 'tax')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/producttag/manage_product_tag') ?>" class="nav-link">
                                        <i class="fas fa-percentage nav-icon"></i>
                                        <p>Tags</p>
                                    </a>
                                </li>
                            ...
                            <?php // if (has_permissions('read', 'product')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/product/create_product') ?>" class="nav-link">
                            ...
                            <?php // if (has_permissions('read', 'product_faqs')) { ?>
                                <!-- <li class="nav-item">
                                    <a href="<?= base_url('admin/productfaqs') ?>" class="nav-link">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('admin/staticpages') ?>" class="nav-link">
                                <i class="fab fa-adversal nav-icon"></i>
                                <p>Static Pages</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('admin/staticpages/create_page') ?>" class="nav-link">
                                <i class="fas fa-plus-square nav-icon"></i>
                                <p>Add Page</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('admin/staticpages/upload_images') ?>" class="nav-link">
                                <i class="fas fa-plus-square nav-icon"></i>
                                <p>Upload Images</p>
                            </a>
                        </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <?php //if (has_permissions('read', 'zipcodes')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/area/manage_zipcodes') ?>" class="nav-link">
                            ...
                            <?php // if (has_permissions('read', 'city')) { ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/area/manage_cities') ?>" class="nav-link">
                ...
                <?php // if (has_permissions('read', 'support_tickets')) { ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="<?= base_url('admin/tickets/ticket_types') ?>" class="nav-link">
                ...
                <?php // if (has_permissions('read', 'promo_code')) { ?>
                    <li class="nav-item">
                        <a href="<?= base_url('admin/promocode') ?>" class="nav-link">
                ...
                <?php // if (has_permissions('read', 'customers')) { ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('admin/transaction/view_transaction') ?>" class="nav-link">
                                    <i class="fas fa-money-bill-wave nav-icon "></i>
                                    <p> Transactions </p>
                                </a>
                            </li>
                ...
                <?php // if (has_permissions('read', 'return_request')) { ?>
                    <li class="nav-item has-treeview">
                        <a href="<?= base_url('admin/returnrequest') ?>" class="nav-link">
                ...
                <?php // if (has_permissions('read', 'return_request')) { ?>
                    <li class="nav-item has-treeview">
                        <a href="<?= base_url('admin/paymentrequest') ?>" class="nav-link">
                ...
                <?php // if (has_permissions('read', 'send_notification')) { ?>
                    <li class="nav-item has-treeview">
                        <a href="<?= base_url('admin/notificationsettings/manage_notifications') ?>" class="nav-link">
                ...
                <?php // if (has_permissions('read', 'settings')) { ?>
                    <li class="nav-item has-treeview">
                        <a href="<?= base_url('admin/customnotification') ?>" class="nav-link">
                ...
                <?php // if (has_permissions('read', 'settings')) { ?>
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('admin/systemhealth') ?>" class="nav-link">
                                    <i class="fas fa-heartbeat nav-icon "></i>
                                    <p>System Health</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/emailsettings') ?>" class="nav-link">
                                    <i class="fas fa-envelope-open-text nav-icon "></i>
                                    <p>Email Settings</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/paymentsettings') ?>" class="nav-link">
                                    <i class="fas fa-rupee-sign nav-icon "></i>
                                    <p>Payment Methods</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/shippingsettings') ?>" class="nav-link">
                                    <i class="fas fa-rocket nav-icon "></i>
                                    <p>Shipping Methods</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/timeslots') ?>" class="nav-link">
                                    <i class="fas fa-calendar-alt nav-icon "></i>
                                    <p>Time Slots</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/authenticationsettings') ?>" class="nav-link">
                                    <i class="fa fa-key nav-icon "></i>
                                    <p>Authentication Mode</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="<?= base_url('admin/notificationsettings') ?>" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="<?= base_url('admin/purchasecode') ?>" class="nav-link">
                    ...
                    ?>
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/websetting') ?>" class="nav-link">
                                ...
                                ?>
                                <li class="nav-item">
                                    <a href="<?= base_url('admin/websetting/firebase') ?>" class="nav-link">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admin/privacypolicy') ?>" class="nav-link">
                                <i class="fa fa-user-secret nav-icon "></i>
                                <p>Privacy Policy</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('admin/privacypolicy/shipping_policy') ?>" class="nav-link">
                                <i class="fa fa-shipping-fast nav-icon "></i>
                                <p>Shipping Policy</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('admin/privacypolicy/return_policy') ?>" class="nav-link">
                                <i class="fa fa-undo nav-icon "></i>
                                <p>Return Policy</p>
                            </a>
                        </li>
                        <li class="nav-item text-sm">
                            <a href="<?= base_url('admin/privacypolicy/admin_policy') ?>" class="nav-link">
                                <i class="fa fa-exclamation-triangle nav-icon  "></i>
                                <p>Admin Policies</p>
                            </a>
                        </li> -->
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url('admin/report/sales_report') ?>" class="nav-link">
                                <i class="fa fa-chart-line nav-icon "></i>
                                <p>Sales Report</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url('admin/report/sales_inventory') ?>" class="nav-link">
                                <i class="fa fa-chart-line nav-icon "></i>
                ...
                ?>
                    <li class="nav-item mb-4">
                        <a href="<?= base_url('admin/systemusers/') ?>" class="nav-link">
