    ...
    <form class="repairPcForm" action="<?= base_url('form-submit') ?>" method="post" enctype="multipart/form-data">
        <div class="form-box one-half name-contact"><label for="exampleInputTitle">Repair Type *</label>
            <div class="dropdown-container">
                <select name="os_type" style="color:#000000;">
                    <option value="Computer Repair" <?php if(old('os_type') && old('os_type') == 'Computer Repair'){ echo "selected"; } ?>>Computer Repair</option>
                    <option value="PC Repair" <?php if(old('os_type') && old('os_type') == 'PC Repair'){ echo "selected"; } ?>>PC Repair</option>
                    <option value="Hardware Repair" <?php if(old('os_type') && old('os_type') == 'Hardware Repair'){ echo "selected"; } ?>>Hardware Repair</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-box one-half name-contact"><label for="exampleInputTitle">Brand *</label>
            <div class="dropdown-container"><select name="os_brand" style="color:#000000;">
                    ...
                    <option value="Other" <?php if(old('os_brand') && old('os_brand') == 'Other'){ echo "selected"; } ?>>Other</option>
                    <option value="Unknown Brand" <?php if(old('os_brand') && old('os_brand') == 'Unknown Brand'){ echo "selected"; } ?>>Unknown Brand</option>
                </select></div>
        </div>
        ...
        <div class="form-box one-half name-contact"><label for="exampleInputName">Year Purchased&nbsp;*</label> <input id="exampleInputName" name="os_year_purchased" placeholder="YYYY" min="1900" max="2099"  type="number" step="1" value="<?php if(old('os_year_purchased')){ echo old('os_year_purchased'); } else{ echo "2025"; } ?>"></div>
        <div class="form-box one-half name-contact"><label for="exampleInputName">Problem&nbsp;*</label>
            <div class="dropdown-container">
                <select id="os_problem" name="os_problem" style="color:#000000;" >
                    <option selected="selected" value="">Please Select</option>
                    <option value="Computers Running Slow" <?php if(old('os_problem') && old('os_problem') == 'Computers Running Slow'){ echo "selected"; } ?>>Computers Running Slow</option>
                    <option value="Computers Running Hot" <?php if(old('os_problem') && old('os_problem') == 'Computers Running Hot'){ echo "selected"; } ?>>Computers Running Hot</option>
