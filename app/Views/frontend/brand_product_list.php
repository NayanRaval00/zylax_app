    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><?= $brand_data['name'] ?></li>
            </ol>
        </nav>
    </div>
</section>
...
<section class="container my-5 product-listing-container">
    ...
    <h4 class="accountpage-title"><?= $brand_data['name_title'] ?></h4>
    <?php if(isset($brand_data['description']) && $brand_data['description'] != ""){ ?>
        <p><?= $brand_data['description'] ?></p>
    <?php } ?>
