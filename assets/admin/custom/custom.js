    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + from + '/product/delete_product_image',
                    data: {
                        id: id
                    },
                    dataType: 'json'
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + from + '/product/delete_related_product',
                    data: {
                        id: id
                    },
                    dataType: 'json'
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + from + '/product/delete_product_feature',
                    data: {
                        id: id
                    },
                    dataType: 'json'
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + from + '/product/delete_product_option',
                    data: {
                        id: id
                    },
                    dataType: 'json'
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + from + '/product/delete_product_variant',
                    data: {
                        id: id
                    },
                    dataType: 'json'
...
$(document).on('click', '.delete-menu-featured-product', function () {
    var id = $(this).data('id');
    Swal.fire({
        title: 'Are You Sure!',
        text: "You won't be able to revert this!",
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + from + '/menu/delete_menu_featured_product',
                    data: {
                        id: id
                    },
                    dataType: 'json'
...
$(document).on('change', '#product-options-category', function () {
    var category_id = $(this).val();
    $("#product_options_category_id").val(category_id);
    // var edit_product_id = $("#edit_product_id").val();
    // $.ajax({
    //     type: 'GET',
    //     url: base_url + from + '/product/product_options_products',
    //     data: {
    //         id: category_id,
    ...
    // }).done(function (response, textStatus) {
    //     if (response.error == false) {
    //         $("#product_options").empty(); // Clear previous options
    //         $("#product_options").append('<option value="">Select Product</option>');

    //         $.each(response.data, function (key, value) {
    //             $("#product_options").append('<option value="' + value.id + '">' + value.name + "</option>");
    //         });
    //     } else {
    //         Swal.fire('Oops...', response.message, 'error');
    //         $("#product_options").empty(); // Clear previous options
...
$(document).on('change', '#product_options', function () {
    ...
    var product_category_id = $("#product_options_category_id").val();
    var product_id = $("#edit_product_id").val();
    $.ajax({
        type: 'GET',
        url: base_url + from + '/product/add_product_options',
        data: {
        ...
        if (response.error == false) {
            ...
            $("#append_product_options").append(`
                <tr id="product_option_${response.data.option_id}">
                    <td>${response.data.product_name}</td>
                    <td>
                        <a class="btn btn-tool delete-product-option" data-id="${response.data.option_id}"> 
...
$(document).on('change', '#related_products_search', function () {
    var related_product_id = $(this).val();
    var product_id = $("#edit_product_id").val();
    $.ajax({
        type: 'GET',
        url: base_url + from + '/product/add_related_product',
        data: {
        ...
        if (response.error == false) {
            ...
            $("#append_related_products").append(`
                <tr id="related_product_${response.data.related_id}">
                    <td>${response.data.product_name}</td>
                    <td>
                        <a class="btn btn-tool delete-related-product" data-id="${response.data.related_id}"> 
                            <i class="text-danger far fa-times-circle fa-2x "></i> 
                        </button>
                    </td>
                </tr>
...
$(document).on('change', '#product_feature', function () {
    ...
    $.ajax({
        type: 'GET',
        url: base_url + from + '/product/add_product_feature',
        data: {
        ...
        if (response.error == false) {
            ...
            $("#append_product_features").append(`
                <tr id="product_feature_${response.data.feature_id}">
                    <td>${response.data.feature_text}</td>
                    <td>
                        <a class="btn btn-tool delete-product-feature" data-id="${response.data.feature_id}"> 
                            <i class="text-danger far fa-times-circle fa-2x "></i> 
                        </button>
                    </td>
                </tr>
...
$(document).on('click', '#add_varient_product', function () {
    var product_id = $(this).data("product-id");
    var product_variation_color = $("#product_variation_color").val();
    var product_variation_title = $("#product_variation_title").val();
    var product_variation_product = $("#product_variation_product").val();
    $.ajax({
        type: 'GET',
        url: base_url + from + '/product/add_product_variations',
        data: {
            product_id: product_id,
            color: product_variation_color,
            label: product_variation_title,
            product_variant_id: product_variation_product,
        },
        dataType: 'json'
    }).done(function (response, textStatus) {
        if (response.error == false) {
            ...
            $("#append_product_color_variants").append(`
                <tr id="product_variant_${response.data.variant_id}">
                    <td> ( Color : ${response.data.color} ) - ( Label : ${response.data.label} ) - ( Product : ${response.data.product_name} )</td>
                    <td>
                        <a class="btn btn-tool delete-product-variant" data-id="${response.data.variant_id}"> 
                            <i class="text-danger far fa-times-circle fa-2x "></i> 
                        </button>
                    </td>
                </tr>
...
$(document).on('click', '#add_menu_featured_product', function () {
    var menu_id = $(this).data("menu-id");
    var product_type = $("#product_type").val();
    var product_id = $("#menu_featured_product").val();

    $.ajax({
        type: 'GET',
        url: base_url + from + '/menu/add_featured_product',
        data: {
            menu_id: menu_id,
        ...
        if (response.error == false) {
            ...
            $("#append_featured_products").append(`
                <tr id="featured_product_${response.data.featured_id}">
                    <td> ( Product Type : ${response.data.product_type} ) - ( Product : ${response.data.product_name} )</td>
                    <td>
                        <a class="btn btn-tool delete-menu-featured-product" data-id="${response.data.featured_id}"> 
                            <i class="text-danger far fa-times-circle fa-2x "></i> 
                        </button>
                    </td>
                </tr>
...
$(document).on('change', '#product_variation_category', function () {
    var category_id = $(this).val();
    $("#product_variation_category_id").val(category_id);
    // var edit_product_id = $("#edit_product_id").val();
    // $.ajax({
    //     type: 'GET',
    //     url: base_url + from + '/product/product_options_products',
    ...
    // }).done(function (response, textStatus) {
    //     if (response.error == false) {
    //         $("#product_variation_product").empty(); // Clear previous options
    //         $("#product_variation_product").append('<option value="">Select Product</option>');

    //         $.each(response.data, function (key, value) {
    //             $("#product_variation_product").append('<option value="' + value.id + '">' + value.name + "</option>");
    //         });
    //     } else {
    //         Swal.fire('Oops...', response.message, 'error');
    //         $("#product_variation_product").empty(); // Clear previous options
...
$(document).on('change', '#menu_product_category', function () {
    var category_id = $(this).val();
    $("#menu_product_category_id").val(category_id);
});
...
$(document).on('click', '.delete-sub_custom_menus', function () {
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + 'admin/menu/delete_sub_custom_menus',
                    data: {
                        id: menu_id
                    },
                    dataType: 'json'
...
$(document).on('click', '.delete-custom_menus', function () {
    var menu_id = $(this).data('id');
    Swal.fire({
        title: 'Are You Sure!',
        text: "You won't be able to revert this!",
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + 'admin/menu/delete_custom_menus',
                    data: {
                        id: menu_id
                    },
                    dataType: 'json'
...
$(document).on('click', '.delete-mega_menus', function () {
    var menu_id = $(this).data('id');
    Swal.fire({
        title: 'Are You Sure!',
        text: "You won't be able to revert this!",
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + 'admin/menu/delete_menus',
                    data: {
                        id: menu_id
                    },
                    dataType: 'json'
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + 'admin/shipping/delete_shipping',
                    data: {
                        id: ship_id
                    },
                    dataType: 'json'
...
$(document).on('click', '.delete-promo-code', function () {
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    url: base_url + 'admin/promocode/delete_promo_code',
                    type: 'GET',
                    data: {
                        'id': id
                    },
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + 'admin/staticpages/delete_page',
                    data: {
                        id: page_id
                    },
                    dataType: 'json'
    ...
    Swal.fire({
        ...
        preConfirm: function () {
            return new Promise((resolve, reject) => {
                $.ajax({
                    type: 'GET',
                    url: base_url + 'admin/staticpages/delete_image',
                    data: {
                        id: image_id
                    },
                    dataType: 'json'
